...
import com.dxc.notification_service.domain.notification.events.ActionCompletedPayload;
...
public class OnActionCompletedHandler {
    ...
    public void handle(ActionCompletedPayload payload) {
        ...
        log.info("Action complétée notifiée: {} — {}", payload.changeKey(), payload.actionTitle());
    }

    private void notifyUser(String userId, ActionCompletedPayload payload) {
        ...
        notificationSender.send(userId, "workflow-action-completed", payload);
    }
}